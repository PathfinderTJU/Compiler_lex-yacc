...
#line 197 "yacc.tab.c" /* yacc.c:339  */
...
{
       0,   143,   143,   158,   166,   174,   183,   192,   203,   212,
     220,   230,   238,   248,   257,   267,   278,   286,   294,   302,
     310,   317,   326,   337,   350,   361,   376,   390,   404,   418,
     431,   443,   455,   466,   473,   484,   493,   502,   511,   520,
     529,   538,   548,   556,   562,   568,   574
};
#endif
...
{
  "$end", "error", "$undefined", "INT", "FLOAT", "ID", "SEMI", "ASSIGNOP",
  "RELOP", "PLUS", "MINUS", "STAR", "DIV", "LP", "RP", "LC", "RC", "WHILE",
  "ELSE", "IF", "RETURN", "TYPE", "VOID", "MAIN", "EASY", "FOR", "$accept",
  "Program", "ExtDefList", "ExtDef", "Specifier", "VarDec", "FunDec",
  "VarList", "ParamDec", "CompSt", "DeflistAndStmtList", "Stmt", "Def",
  "Dec", "Exp", YY_NULLPTR
};
#endif
...
{
     -14,   -79,    -4,     4,   -79,   -14,     1,    -3,     5,    22,
     -79,   -79,    -3,    25,    22,    32,    -9,    34,    42,   -79,
     165,   -79,   -79,   -79,    44,    37,   -79,   -79,   -79,   -79,
      45,   165,    52,    60,   165,    68,    62,    44,   -79,    65,
      42,    42,   170,   204,   -79,   -79,   -79,    75,     9,   165,
     165,   177,   -79,    50,    77,   -79,   -79,   -79,   -79,   165,
     165,   165,   165,   165,   165,   -79,   101,   109,   117,   -79,
     153,   184,   -79,    81,    81,     9,     9,   210,   210,   -79,
      67,    67,    76,   191,   161,   -79,    83,    67,    90,   165,
     198,    67,   -79,    67,   125,   133,    93,   -79,   -79,    67,
      67,    67,   141,   -79,   -79,   -79,    67,   -79
};
...
{
       4,     8,     0,     0,     2,     4,     0,     0,     0,     0,
       1,     3,     9,    33,     0,     0,     0,     0,    18,     7,
       0,     6,     5,    11,     0,     0,    13,    12,    44,    45,
      43,     0,     0,     0,     0,     0,     0,     0,    20,     0,
      18,    18,     0,    34,     9,    14,    10,     0,    46,     0,
       0,     0,    31,     0,     0,    15,    17,    16,    19,     0,
       0,     0,     0,     0,     0,    42,     0,     0,     0,    21,
       0,     0,    32,    35,    36,    37,    38,    39,    40,    41,
       0,     0,     0,     0,     0,    24,    22,     0,     0,     0,
       0,     0,    30,     0,     0,     0,     0,    23,    29,     0,
       0,     0,     0,    26,    27,    28,     0,    25
};
...
{
      43,     7,    85,    86,    10,    23,    12,     1,     2,    92,
      16,    48,     1,    97,    51,    98,    59,    60,    17,     8,
       6,   103,   104,   105,     8,     6,    19,    66,   107,    67,
      68,    21,    20,    71,    56,    57,    24,    18,    22,    73,
      74,    75,    76,    77,    78,    28,    29,    30,    27,    44,
      83,    46,    31,    28,    29,    30,    70,    18,    47,    32,
      31,    33,    34,     1,    90,    49,    35,    36,    94,    95,
      28,    29,    30,    50,    52,    53,   102,    31,    28,    29,
      30,    55,    18,    72,    32,    31,    33,    34,    59,    65,
      87,    35,    36,    28,    29,    30,    28,    29,    30,    11,
      31,    91,    45,    31,    93,    14,    54,   101,    59,    60,
      61,    62,    63,    64,     0,    79,    59,    60,    61,    62,
      63,    64,     0,    80,    59,    60,    61,    62,    63,    64,
       0,    81,    59,    60,    61,    62,    63,    64,     0,    99,
      59,    60,    61,    62,    63,    64,     0,   100,    59,    60,
      61,    62,    63,    64,     0,   106,    28,    29,    30,    82,
       0,     0,     0,    31,    28,    29,    30,    89,    28,    29,
      30,    31,     0,     0,     0,    31,    58,    59,    60,    61,
      62,    63,    64,    69,    59,    60,    61,    62,    63,    64,
      84,    59,    60,    61,    62,    63,    64,    88,    59,    60,
      61,    62,    63,    64,    96,    59,    60,    61,    62,    63,
...
{
      20,     5,    80,    81,     0,    14,     5,    21,    22,    87,
      13,    31,    21,    91,    34,    93,     7,     8,    13,    23,
       0,    99,   100,   101,    23,     5,     9,    47,   106,    49,
      50,    14,     7,    53,    40,    41,    16,    15,     6,    59,
      60,    61,    62,    63,    64,     3,     4,     5,    14,     5,
      70,    14,    10,     3,     4,     5,     6,    15,    13,    17,
      10,    19,    20,    21,    84,    13,    24,    25,    88,    89,
       3,     4,     5,    13,     6,    13,    96,    10,     3,     4,
       5,    16,    15,     6,    17,    10,    19,    20,     7,    14,
      14,    24,    25,     3,     4,     5,     3,     4,     5,     5,
      10,    18,    24,    10,    14,     6,    37,    14,     7,     8,
       9,    10,    11,    12,    -1,    14,     7,     8,     9,    10,
      11,    12,    -1,    14,     7,     8,     9,    10,    11,    12,
      -1,    14,     7,     8,     9,    10,    11,    12,    -1,    14,
       7,     8,     9,    10,    11,    12,    -1,    14,     7,     8,
       9,    10,    11,    12,    -1,    14,     3,     4,     5,     6,
      -1,    -1,    -1,    10,     3,     4,     5,     6,     3,     4,
       5,    10,    -1,    -1,    -1,    10,     6,     7,     8,     9,
...
{
       0,    21,    22,    27,    28,    29,    30,     5,    23,    32,
       0,    28,     5,    31,    32,    39,    13,    13,    15,    35,
       7,    35,     6,    14,    30,    33,    34,    14,     3,     4,
       5,    10,    17,    19,    20,    24,    25,    30,    35,    36,
      37,    38,    40,    40,     5,    31,    14,    13,    40,    13,
      13,    40,     6,    13,    39,    16,    36,    36,     6,     7,
       8,     9,    10,    11,    12,    14,    40,    40,    40,     6,
       6,    40,     6,    40,    40,    40,    40,    40,    40,    14,
      14,    14,     6,    40,     6,    37,    37,    14,     6,     6,
      40,    18,    37,    14,    40,    40,     6,    37,    37,    14,
      14,    14,    40,    37,    37,    37,    14,    37
};
...
#line 174 "yacc.y" /* yacc.c:1646  */
    {   printf("ExtDef -> Specifier Dec SEMI\n");
                                head = list -> next;
                                alloc(child);
                                child[0] = (head->next) -> data;
                                child[1] = head -> data;
...
#line 192 "yacc.y" /* yacc.c:1646  */
    {   printf("ExtDef -> VOID FunDec CompSt\n");
                                head = list -> next;
                                alloc(child);
...
#line 267 "yacc.y" /* yacc.c:1646  */
    {       printf("CompSt -> LC DeflistAndStmtList RC\n");
                                        head = list -> next;
                                        alloc(child);
...
#line 278 "yacc.y" /* yacc.c:1646  */
    {       printf("DeflistAndStmtList -> Def DeflistAndStmtList\n");
                                                head = list -> next;
                                                alloc(child);
                                                child[0] = (head -> next) -> data;
                                                child[1] = head -> data;
...
#line 286 "yacc.y" /* yacc.c:1646  */
    {       printf("DeflistAndStmtList -> Stmt DeflistAndStmtList\n");
                                                head = list -> next;
                                                alloc(child);
                                                child[0] = (head -> next) -> data;
                                                child[1] = head -> data;
...
#line 361 "yacc.y" /* yacc.c:1646  */
    {    printf("Stmt -> FOR LP Exp SEMI Exp SEMI Exp RP Stmt\n");
                                                head = list -> next;
                                                alloc(child);
...
#line 376 "yacc.y" /* yacc.c:1646  */
    {    printf("Stmt -> FOR LP SEMI Exp SEMI Exp RP Stmt\n");
                                            head = list -> next;
                                            alloc(child);
                                            child[0] = createLeaf("FOR");
                                            child[1] = createLeaf("LP");
...
#line 390 "yacc.y" /* yacc.c:1646  */
    {    printf("Stmt -> FOR LP Exp SEMI SEMI Exp RP Stmt\n");
                                            head = list -> next;
                                            alloc(child);
                                            child[0] = createLeaf("FOR");
                                            child[1] = createLeaf("LP");
...
#line 404 "yacc.y" /* yacc.c:1646  */
    {    printf("Stmt -> FOR LP Exp SEMI Exp SEMI RP Stmt\n");
                                            head = list -> next;
                                            alloc(child);
                                            child[0] = createLeaf("FOR");
                                            child[1] = createLeaf("LP");
...
#line 418 "yacc.y" /* yacc.c:1646  */
    {       printf("Stmt -> FOR LP SEMI Exp SEMI RP Stmt\n");
                                            head = list -> next;
                                            alloc(child);
                                            child[0] = createLeaf("FOR");
                                            child[1] = createLeaf("LP");
...
#line 431 "yacc.y" /* yacc.c:1646  */
    {       printf("Stmt -> FOR LP SEMI SEMI RP Stmt\n");
                                        head = list -> next;
                                        alloc(child);
                                        child[0] = createLeaf("FOR");
                                        child[1] = createLeaf("LP");
...
#line 443 "yacc.y" /* yacc.c:1646  */
    {       printf("Stmt -> EASY SEMI\n");
                        ...
                        T = createTree("Stmt", child, 6);
                        linkListInset(list, T);}
#line 1870 "yacc.tab.c" /* yacc.c:1646  */
    break;
...
#line 568 "yacc.y" /* yacc.c:1646  */
    {     printf("Exp -> FLOAT\n");
                ...
                T = createTree("Exp", child, 1);
                linkListInset(list, T);}
#line 2055 "yacc.tab.c" /* yacc.c:1646  */
    break;
